...
public class CrosswordPuzzle {
    ...
    static ArrayList<String> compareWords = new ArrayList<>();
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = tableSize - 1; i > -1; i--) {
            ...
            for (int j = randomOne; j > 0; j--) {
                dictionaryWords[i][rand.nextInt(tableSize)] = false;
            }
    ...
    private static boolean solvePuzzle(ArrayList<Puzzle> puzzle, char[][] table, int cur_word_start) {
        ...
        for (String word : sortAsciiValue(dictionaryWords)) {
    ...
    public static void lengthOrganizer(String filename) throws IOException { // find dictionaryWords length
        System.out.println("------------------\nLength of Words: ");
    ...
    public static List<String> sortAsciiValue(List<String> words) {
        List<String> sortedList;

        Map<String, Integer> wordsWithValue = new HashMap<>();
        ...
        for (String word : words) {
            ...
            wordsWithValue.put(word, asciiValue);
        }

        Map<String, Integer> sortedWordsWithValue = wordsWithValue.entrySet().stream()
                .sorted(Collections.reverseOrder(Map.Entry.comparingByValue()))
                .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (e1, e2) -> e1, LinkedHashMap::new));

        sortedList = new ArrayList<>(sortedWordsWithValue.keySet());
